...
(0, node_test_1.default)('buildEligiblePlayerIdsFromPlateauAttendance returns null when attendance is empty', () => {
    const eligible = (0, match_eligibility_1.buildEligiblePlayerIdsFromPlateauAttendance)([]);
    strict_1.default.equal(eligible, null);
});
(0, node_test_1.default)('buildEligiblePlayerIdsFromPlateauAttendance includes present and convoked players only', () => {
    const eligible = (0, match_eligibility_1.buildEligiblePlayerIdsFromPlateauAttendance)([
...
(0, node_test_1.default)('buildEligiblePlayerIdsFromPlateauAttendance supports legacy PLATEAU marker without present field', () => {
    const eligible = (0, match_eligibility_1.buildEligiblePlayerIdsFromPlateauAttendance)([
